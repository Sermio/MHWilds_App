...
class MonstersList2 extends StatefulWidget {
  const MonstersList2({super.key});

  @override
  State<MonstersList2> createState() => _MonstersList2State();
}

class _MonstersList2State extends State<MonstersList2> {
